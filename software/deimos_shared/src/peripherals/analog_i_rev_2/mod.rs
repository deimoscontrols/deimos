...
pub use byte_struct::ByteStructLen;

pub mod operating_roundtrip;
use operating_roundtrip::{OperatingRoundtripInput, OperatingRoundtripOutput};
...
impl Peripheral for AnalogIRev2 {
    fn model_number(&self) -> u64 {
        super::model_numbers::ANALOG_I_REV_2_MODEL_NUMBER
    }
    ...
    fn id(&self) -> PeripheralId {
        PeripheralId {
            model_number: super::model_numbers::ANALOG_I_REV_2_MODEL_NUMBER,
