...
pub mod filters {
    ...
    pub const ADC_FILTER_COUNT: usize = 18;
    ...
    /// Nominal rev7 ADC sampling rate.
    pub const ADC_SAMPLE_RATE_HZ: f64 = 33_000.0;
    ...
    mod tests {
        ...
        fn rev7_adc_filter_helpers_build_full_banks() {
            ...
            let fractional_delay_filters =
                adc_fractional_delay_filter_bank(ADC_SAMPLE_RATE_HZ).unwrap();
            let fractional_delay_transfer_functions =
                adc_fractional_delay_transfer_functions(ADC_SAMPLE_RATE_HZ).unwrap();
...
pub use filters::{
    ...
    AdcFractionalDelayTransferFunction, AdcFractionalDelayTransferFunctionBank, ADC_CLOCK_HZ,
    ADC_CONVERSION_CYCLES, ADC_FILTER_COUNT, ADC_FILTER_MAX_CUTOFF_RATIO, ADC_FILTER_ORDER,
    ADC_FILTER_SECTIONS, ADC_FRACTIONAL_DELAY_FILTER_TAPS, ADC_SAMPLE_HOLD_CYCLES,
    ADC_SAMPLE_RATE_HZ,
};
