...
class DeimosDaqRev7(_PeripheralBase):
    ...
    is required for synchronized measurements. This returns only the snapshot,
    not configuration registers.

    For configuration readback, a separate FC23 may write one complete block
    and read holding registers 0..34. That read reflects its preceding write
    but does not return snapshot data.
    """
